...
<script>
   $(function(){
		...
		a.click(function () {
			...
			form1.action = "<%=request.getContextPath()%>/service/getDwxx/1/bio_id:${bioNo}";
			form1.submit();
		});
	});
</script> -->
    ...
    <TR> 
      <TD align="center" class="line2"> <table width="250" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="50%" align="left"> <input name="bioNo" id="bioNo" type="text" maxlength="32" value=""></td>
          </tr>
        </table></TD>
    </TR>
    <TR> 
      <TD align="center" class="line1"> <table width="250" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="50%" align="left"> <input name="bioName" id="bioName" type="text" maxlength="32" value=""></td>
          </tr>
        </table></TD>
    </TR> 
</TABLE>
